...
ggsave(paste0(working_fold,"/external/presentation/rh_points.png"), rh_points, width = 5, height = 4, dpi = 300)
```
...
ggsave(paste0(working_fold,"/external/presentation/pai_points.png"), pai_points, width = 5, height = 4, dpi = 300)
```
