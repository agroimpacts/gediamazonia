...
off of the rGEDI tutorial created by Carlos Alberto Silva. The code and 
descriptions below are all a part of our methodology. It is continued into the
GEDI_Visualizations.Rmd file.

#### Carlos Alberto Silva, Caio Hamamura, Ruben Valbuena, 
#### Steven Hancock, Adrian Cardil, Eben N. Broadbent, Danilo R. A. de Almeida, 
#### Celso H. L. Silva Junior and Carine Klauberg provides several useful tools for 
...
**IF ACQUIRING DATA, UNCOMMENT DOWNLOAD CODE BELOW!!**
...
We must remove all NA values in the coordinate fields and convert shotnumber to 
...
Plant Area Index and volume density are exported as shapefiles and are available 
