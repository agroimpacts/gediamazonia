...
data(gedi_rdist, package = "gediamazonia")
data(gedi_ss, package = "gediamazonia")
data(roads, package = "gediamazonia")
...
cacao_PAI <- st_intersection(x = cacao_zone, y = clipped_2B)
park_PAI <- st_intersection(x = park, y = clipped_2B)
buffer_PAI <- st_intersection(x = buffer, y = clipped_2B)
