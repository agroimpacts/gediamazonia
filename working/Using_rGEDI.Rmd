...
raster::shapefile(level1bGeo_spdf,paste0(outdir,"GEDI01_B_2019216034003_O03638_T04321_02_003_01"))
```
...
#read in shapefile
level1bShp <- st_read(dsn = "C:/Users/Amanda/Documents/gediamazonia/working/GEDI01_B_2019216034003_O03638_T04321_02_003_01.shp")
...
coords <- cbind("x" = c(ul_lat, ul_lat, lr_lat, lr_lat, ul_lat), 
                "y" = c(ul_lon, lr_lon, lr_lon, ul_lon, ul_lon))
...
```{r}
par(mar = c(0, 0, 0, 0))
plot(st_geometry(level1bShp), col = "grey")
